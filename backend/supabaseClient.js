...
function createMockClient() {
  ...
  const tables = {
    listings: [
      { id: 1, title: 'Sunny Studio on College Ave', description: 'Cozy studio right on College Ave, steps from the Rutgers Student Center.', price_monthly: 950, campus_location: 'College Ave', beds: 0, property_type: 'Studio', distance: '0.2 miles', amenities: { parking: true, laundry: true, gym: false }, host_id: 'user_1', created_at: '2026-01-15T10:00:00Z', image:"https://easydrawingguides.com/wp-content/uploads/2022/04/how-to-draw-a-simple-house-featured-image-1200.png" },
      ...
      { id: 4, title: 'Modern 1BR at The Yard', description: 'Recently built apartment at The Yard with gym and parking included.', price_monthly: 1500, campus_location: 'College Ave', beds: 1, property_type: 'Apartment', distance: '0.4 miles', amenities: { parking: true, laundry: true, gym: true, petFriendly: true }, host_id: 'user_1', created_at: '2026-02-20T16:45:00Z' },
      ...
      { id: 9, title: 'Private Room off Livingston Ave', description: 'Room in a quiet 3BR house, 10 min bus to Busch campus.', price_monthly: 700, campus_location: 'Livingston', beds: 1, property_type: 'Room', distance: '1.2 miles', amenities: { parking: true, laundry: false, gym: false, furnished:true }, host_id: 'user_8', created_at: '2026-03-07T09:00:00Z' },
      { id: 10, title: 'Studio near Douglass Library', description: 'Small studio on Nichol Ave, perfect for summer sublet near Cook campus.', price_monthly: 850, campus_location: 'Cook/Douglass', beds: 1, property_type: 'Studio', distance: '0.3 miles', amenities: { parking: false, laundry: true, gym: false }, host_id: 'user_9', created_at: '2026-03-07T10:00:00Z' },
    ],
    favorites: [
